...
export default function Year4() {
  ...
  const handleSaveSubjects = async (id) => {
    try {
        ...
        const data = { Subject1: subject1, Subject2: subject2, Subject3: subject3, Subject4: subject4   };
...
<ToastContainer />
    ...
    .map((item, index) => {
        ...
        const percentage = ((item.SGPA_1 + item.SGPA_2 + item.SGPA_3 + item.SGPA_4 + item.SGPA_5) / 5) * 10;
    ...
    .map((item, index) => (
        <tr key={index}>
            ...
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{item.SGPA_5}</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{item.Active_Backlog}</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{(item.SGPA_1 + item.SGPA_2 + item.SGPA_3 + item.SGPA_4 + item.SGPA_5) / 5}</td>
            ...
            <div>  
                  ...
                  <input defaultValue={item.Subject1} onChange={(e) => setSubject1(e.target.value)} placeholder="Enter subject" className="bg-yellow-200  shadow-lg mb-1 px-1"></input>
                  <input defaultValue={item.Subject2} onChange={(e) => setSubject2(e.target.value)} placeholder="Enter subject" className="bg-yellow-200 -md shadow-lg mb-1 px-1 "></input>
                  <input defaultValue={item.Subject3} onChange={(e) => setSubject3(e.target.value)} placeholder="Enter subject" className="bg-yellow-200 -md shadow-lg mb-1 px-1"></input>
                  <input defaultValue={item.Subject4} onChange={(e) => setSubject4(e.target.value)} placeholder="Enter subject" className="bg-yellow-200 -md shadow-lg mb-2 px-1 "></input>
    ...
    .map((item, index) => {
        // Calculate percentage
        const percentage = ((item.SGPA_1 + item.SGPA_2 + item.SGPA_3 + item.SGPA_4 + item.SGPA_5 + item.SGPA_6) / 6) * 10;
    ...
    .map((item, index) => (
        ...
        <tr key={index}>
            ...
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{item.SGPA_4}</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{item.SGPA_5}</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{item.SGPA_6}</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{item.Active_Backlog}</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{(item.SGPA_1 + item.SGPA_2 + item.SGPA_3 + item.SGPA_4 + item.SGPA_5 + item.SGPA_6) / 6}</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{item.percentage} %</td>
            <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">
